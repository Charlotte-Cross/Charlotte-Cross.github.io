...
| Context / Element                  | Foreground | Background | Contrast Ratio | 
|-----------------------------------|-----------:|-----------:|---------------:|
| Body text                         | `#164823`  | `#DBFFDF`  | **9.76:1**    | 
| Navigation links / text           | `#164823`  | `#7fbc92`  | **4.79:1**    |
| Card text on card background      | `#164823`  | `#f6f8fb`  | **9.94:1**     |
| Primary button text on button     | `#164823`  | `#6FA380`  | **3.64:1**     |
